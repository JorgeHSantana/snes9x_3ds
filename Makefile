...
CPPFILES	:= Snes9x/cpuexec.cpp Snes9x/sa1cpu.cpp Snes9x/sa1.cpp \
			...
			Snes9x/cliphw.cpp Snes9x/tile.cpp Snes9x/gfx.cpp Snes9x/gfxhw.cpp Snes9x/msu1.cpp Snes9x/apulock.cpp \
			png_utils.cpp 3dsutils.cpp 3dsmain.cpp 3dsmenu.cpp 3dsmsu.cpp 3dsmsu_ndsp.cpp 3dstimer.cpp \
