...
COMMON      := $(OPT_FLAGS) $(WARNINGS) -mword-relocations -fomit-frame-pointer -ffunction-sections -DVERSION_MAJOR=$(APP_VERSION_MAJOR) -DVERSION_MINOR=$(APP_VERSION_MINOR) -DVERSION_MICRO=$(APP_VERSION_MICRO) $(ARCH) $(INCLUDE) -D__3DS__ -DUNZIP_SUPPORT -DDETERMINISM_PROBE
...
CPPFILES	:= Snes9x/cpuexec.cpp Snes9x/sa1cpu.cpp Snes9x/sa1.cpp \
			...
			Snes9x/cliphw.cpp Snes9x/tile.cpp Snes9x/gfx.cpp Snes9x/gfxhw.cpp Snes9x/msu1.cpp \
			png_utils.cpp 3dsutils.cpp 3dsmain.cpp 3dsmenu.cpp 3dsmsu.cpp 3dsrewind.cpp 3dsmsu_ndsp.cpp 3dstimer.cpp \
