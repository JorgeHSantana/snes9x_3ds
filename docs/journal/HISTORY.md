...
| 78 | Auditoria de otimização Old/New 3DS | ABERTA | Primeira rodada: erros de SRAM/savestate, workspace de serialização, Mode 7 e dependência citro3d; testes host/ARM e RGB/savestates exatos no Azahar. Demais investigações e medições no console pendentes |
